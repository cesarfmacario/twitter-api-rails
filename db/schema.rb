...
ActiveRecord::Schema.define(version: 2019_01_24_212205) do
  ...
  create_table "usuario_sesions", force: :cascade do |t|
    t.integer "usuario_id"
    t.string "token"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["usuario_id"], name: "index_usuario_sesions_on_usuario_id"
  end
